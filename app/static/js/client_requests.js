$('.my-feature-request-link').click(function() {
              ...
              success: function(data) {
                swal("Success!", "Message sent!", "success")
                   .then(function() {
                      ...
                      $('#messages-'+correspondence_id).append('<div class="message-wrapper"><div class="message '+floatSide+'">\
    ...
    success: function(res) {
      if(res.messages.length == 0) {
        ...
        res.messages.map(message => {
          ...
          $('#messages-'+correspondence_id).append('<div class="message-wrapper"><div class="message '+floatSide+'">\
            <p><b>'+ message.user_first_name + ' ' + message.user_last_name +'</b></p>\
            '+ message.message +'\
          </div></div>')
              ...
              swal("Success!", "Admin has been successfully saved!", "success")
                 .then(function() {
                    ...
                    <div class="card-body">\
                      ...
                      <button type="button" data-correspondence='+data.correspondence+' class="btn btn-sm btn-secondary float-right">Open Conversation</button>\
                    </div>\
                  </div>'
                    )
                  });
